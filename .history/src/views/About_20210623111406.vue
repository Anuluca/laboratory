<template>
  <div class="poke-watch">
    ...
    <div style="width:100vw;margin-top:100px">
      <a href="" @Click="changeType = 'blue-type'">切换到蓝色款</a
      >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="" @Click="changeType = 'red-type'"
        >切换到红色款</a
      >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="" @Click="changeType = 'orange-type'"
        >切换到橙色款</a
      >
    </div>
  </div>
